...
RAYON_NUM_THREADS=64 cargo bench --package hyperplonk --no-default-features --features=bench
...
#RAYON_NUM_THREADS=1 cargo bench --package hyperplonk --no-default-features --features=bench